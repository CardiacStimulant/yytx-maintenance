...
-- 初始化资源
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('用户管理', 'menu', 'system', 'userManager', '/fe/user#/', '用户管理菜单', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('角色管理', 'menu', 'system', 'roleManager', '/fe/role#/', '角色管理菜单', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('资源管理', 'menu', 'system', 'resourceManager', '/fe/resource#/', '资源管理描述', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('日志查询', 'menu', 'system', 'operationLog', '/fe/log#/', '日志查询菜单', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('新增', 'button', 'system', 'add', NULL, '新增按钮', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('编辑', 'button', 'system', 'edit', NULL, '编辑按钮', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('删除', 'button', 'system', 'delete', NULL, '删除按钮', '0', '0', '管理员', now(), '管理员', now());
INSERT INTO `base_resource` (`name`, `type`, `owner`, `key`, `url`, `comments`, `version`, `dr`, `last_modify_user`, `last_modified`, `create_user`, `create_time`) VALUES ('配置', 'button', 'system', 'roleConfig', NULL, '角色配置资源按钮', '0', '0', '管理员', now(), '管理员', now());
